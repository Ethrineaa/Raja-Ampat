...
export interface Activity {
  ...
  title: string;
  desc?: string;
  icon?: IconType;   // ⬅️ icon sekarang component
}
...
export const activities: Activity[] = [
  {
    id: 'diving',
    title: 'Diving',
    desc: 'Discover vibrant coral reefs.',
    icon: FaWater,
  },
  {
    id: 'snorkeling',
    title: 'Snorkeling',
    desc: 'Swim with turtles and fish.',
    icon: FaSwimmer,
  },
  {
    id: 'island-hopping',
    title: 'Island Hopping',
    desc: 'Explore hidden lagoons.',
    icon: FaShip,
  },
  {
    id: 'photography',
    title: 'Photography',
    desc: 'Capture sunset moments.',
    icon: FaCamera,
  },
];
...
export const gallery: GalleryItem[] = [
  ...
  {
    id: 'g5',
    image: 'https://images.unsplash.com/photo-1526779259212-8e6b3b2f6a5b?auto=format&fit=crop&w=800&q=80',
    alt: 'Beach',
  },
  {
    id: 'g6',
